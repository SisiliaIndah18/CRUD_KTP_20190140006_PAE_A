 ...
 */
package crud.ktp.project.pae.a;

import crud.ktp.project.pae.a.exceptions.NonexistentEntityException;
import crud.ktp.project.pae.a.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("crud.ktp_project.pae.a_jar_0.0.1-SNAPSHOTPU");
